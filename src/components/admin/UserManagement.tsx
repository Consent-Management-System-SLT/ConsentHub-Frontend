        ...
        <div role="dialog" aria-modal="true" aria-labelledby="usermanagement-dialog-4-title" className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className={`bg-white rounded-xl shadow-lg border border-gray-200 ${
            ...
            <div className="p-6 border-b border-gray-200 bg-white rounded-t-xl">
              <h3 id="usermanagement-dialog-4-title" className="text-lg font-semibold text-gray-900">
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                     aria-label="Relationship to Dependents">
                      <option value="parent">Parent</option>
                      <option value="guardian">Guardian</option>
                      <option value="grandparent">Grandparent</option>
                      <option value="other">Other</option>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    ...
                    className="flex flex-wrap items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                  >
                    <Plus className="w-4 h-4" />
                    Add Child
                  </button>
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={loading}
                className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex flex-wrap items-center gap-2"
              >
                {loading ? (
                  <>
