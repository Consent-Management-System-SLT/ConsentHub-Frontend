    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-slate-600 text-lg">No compliance rules found</p>
          <button
            onClick={() => setShowAddModal(true)}
            className="bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg px-4 py-2 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 mt-4 px-4 py-2"
          >
            ...
            <div key={rule._id} className="bg-white border border-slate-200 rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium text-slate-900">{rule.ruleType}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg px-4 py-2 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 px-3 py-2 flex items-center justify-center space-x-2 text-sm"
                >
                ...
                <button
                  ...
                  className="p-2 text-blue-600 hover:text-blue-600-hover hover:bg-blue-50/10 rounded-lg transition-colors"
                >
