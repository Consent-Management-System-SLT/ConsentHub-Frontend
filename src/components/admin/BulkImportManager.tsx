  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {showErrorModal && selectedImport && selectedImport.errors && (
        <div role="dialog" aria-modal="true" aria-labelledby="bulkimportmanager-dialog-2-title" className="fixed inset-0 bg-slate-900/50 z-50 flex items-center justify-center p-4">
