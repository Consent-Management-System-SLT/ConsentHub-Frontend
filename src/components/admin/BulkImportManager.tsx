  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {showErrorModal && selectedImport && selectedImport.errors && (
        <div role="dialog" aria-modal="true" aria-labelledby="bulkimportmanager-dialog-2-title" className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h3 id="bulkimportmanager-dialog-2-title" className="text-lg font-semibold text-gray-900">
