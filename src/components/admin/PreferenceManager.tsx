                ...
                <tr key={preference.id} className={`${index % 2 === 0 ? 'bg-white border border-slate-200 rounded-xl shadow-sm' : 'bg-slate-50'} hover:bg-slate-50 transition-colors`}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex items-center space-x-2">
                      <button aria-label="View data" className="text-blue-600 hover:text-blue-600 p-1 hover:bg-blue-50/10 rounded transition-colors">
                        <Database className="w-4 h-4" />
                      </button>
                      <button aria-label="Settings" className="text-slate-600 hover:text-slate-900 p-1 hover:bg-slate-50/20 rounded transition-colors">
