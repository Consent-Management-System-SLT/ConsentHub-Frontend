        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          ...
          <div className="flex flex-wrap flex-row space-x-3 items-center justify-between sm:justify-start">
            <div className="flex-shrink-0 sm:hidden lg:block">
              <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-white/15 rounded-full flex items-center justify-center">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          {quickActions.map((action) => (
            <button
              key={action.action}
              className={`p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl border-2 transition-all duration-200 text-left hover:shadow-md hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-600/50 hover:shadow-md.5 transition-all ${action.color}`}
              onClick={() => {
                if (onNavigate) {
