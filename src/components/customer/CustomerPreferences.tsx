              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-200/10">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent bg-white text-slate-900"
          ...
          <div className="p-6 space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent bg-white text-slate-900"
               aria-label={t('preferences.frequencySettings.maxEmails')}>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent bg-white text-slate-900"
               aria-label={t('preferences.frequencySettings.maxSms')}>
