          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 lg:gap-4">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <div className="w-7 h-7 sm:w-8 sm:h-8 lg:w-9 lg:h-9 bg-blue-50 rounded-full flex items-center justify-center flex-shrink-0">
                <button type="button" onClick={onProfileClick} className="w-full h-full bg-blue-50 rounded-full flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-blue-500 hover:bg-blue-50/80 transition-all duration-200">
