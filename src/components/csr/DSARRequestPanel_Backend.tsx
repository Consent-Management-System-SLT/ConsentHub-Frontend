                    ...
                    {request.status === 'pending' && (
                      <>
                        <button
                          ...
                          className="px-3 py-1 bg-green-700 text-white rounded text-sm hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-1"
                        >
