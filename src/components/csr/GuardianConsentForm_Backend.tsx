        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">Manage consent for minor customers</p>
            </div>
          </div>
          {onClose && (
              ...
              {filteredMinors.map(minor => (
                <div key={minor.id} className="bg-white border border-slate-200 rounded-lg p-4 hover:bg-white transition-colors">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-medium text-slate-900">{minor.name}</h3>
                      <p className="text-sm text-slate-600">{minor.email}</p>
                    </div>
                  </div>
