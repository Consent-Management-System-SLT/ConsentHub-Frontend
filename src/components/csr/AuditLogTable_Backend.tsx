...
const AuditLogTable: React.FC<AuditLogTableProps> = ({ 
        ...
        <div className="p-6 border-b border-slate-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">System activity and event logs</p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className={`bg-white rounded-lg shadow-lg ${className}`}>
      ...
      {/* Filters */}
      <div className="p-4 border-b border-slate-200 bg-white border border-slate-200">
        <div className="flex flex-wrap gap-4 items-center">
          ...
          {(searchTerm || filterType !== 'all' || filterDate) && (
            <button
              ...
              className="px-3 py-2 text-sm text-slate-600 hover:text-gray-800"
            >
              Clear Filters
            </button>
          )}
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredLogs.map((log) => (
                <tr key={log.id} className="hover:bg-white border border-slate-200">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-slate-900">{formatDate(log.createdAt)}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-slate-900">{log.partyId || 'N/A'}</div>
                  </td>
