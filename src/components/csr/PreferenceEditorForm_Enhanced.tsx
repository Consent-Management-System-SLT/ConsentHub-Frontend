              ...
              <div className="mt-2 max-h-60 overflow-y-auto border border-gray-200 rounded-lg">
                {filteredCustomers.map(customer => (
                  <div
                    ...
                    className="p-3 hover:bg-white border border-slate-200 cursor-pointer border-b border-slate-200 last:border-b-0"
                  >
                    <div className="flex items-center space-x-3">
          ...
          {isEditing && (
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
              <button
                ...
                className="px-6 py-2 border border-gray-300 text-slate-600 rounded-lg hover:bg-white border border-slate-200"
              >
                Cancel
              </button>
              <button
