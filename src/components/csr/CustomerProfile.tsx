    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {recentActivities.length > 0 ? (
              <div className="space-y-4">
                {recentActivities.map((activity, index) => (
                  <div key={index} className="flex flex-wrap items-start space-x-3 p-4 bg-white border border-slate-200 rounded-lg">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center px-4 py-3 text-left bg-white border border-slate-200 hover:bg-white rounded-lg transition-colors"
              >
                <Activity className="w-5 h-5 text-slate-600 mr-3" />
                <div>
                  <p className="font-medium text-slate-900">View Audit Trail</p>
          ...
          {/* Status Alerts */}
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Status Alerts</h3>
            <div className="space-y-3">
