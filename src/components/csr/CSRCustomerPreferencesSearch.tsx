              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50/5 rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {Object.entries(preferences.preferredChannels).map(([channel, enabled]) => (
                      <div key={channel} className="flex items-center space-x-2 p-3 bg-white border border-slate-200 rounded-xl shadow-sm">
                        {enabled ? (
                ...
                <div className="bg-blue-50/5 rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {Object.entries(preferences.topicSubscriptions).map(([topic, enabled]) => (
                      <div key={topic} className="flex items-center space-x-2 p-3 bg-white border border-slate-200 rounded-xl shadow-sm">
                        {enabled ? (
                          <Check className="w-4 h-4 text-green-500" />
                        ) : (
                          <X className="w-4 h-4 text-red-500" />
                ...
                <div className="bg-blue-50/5 rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center space-x-3 p-3 bg-white border border-slate-200 rounded-xl shadow-sm">
