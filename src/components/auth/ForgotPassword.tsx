        ...
        <div className="max-w-sm sm:max-w-md w-full space-y-4 sm:space-y-6 md:space-y-8">
          <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
            <div className="text-center">
              <CheckCircle className="mx-auto h-12 w-12 sm:h-16 sm:w-16 text-green-700 mb-3 sm:mb-4" />
              ...
              <Link
                to="/login"
                className="bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg px-4 py-2 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 w-full inline-flex justify-center py-2.5 sm:py-3 text-sm"
              >
                Back to Login
              </Link>
            </div>
