import { BrowserRouter as Router, Routes, Route, Navigate } from 'react-router-dom';import { AuthProvider } from './contexts/AuthContext';import { NotificationProvider } from './contexts/NotificationContext';import { ThemeProvider } from './contexts/ThemeContext';import Login from './components/auth/Login';import Signup from './components/auth/Signup';import ForgotPassword from './components/auth/ForgotPassword';import EasyApplyLogin from './components/customer/EasyApplyLogin';import EasyApplyConsents from './components/customer/EasyApplyConsents';import RoleBasedDashboard from './components/RoleBasedDashboard';import ProtectedRoute from './components/ProtectedRoute';import ToastContainer from './components/ToastContainer';
      ...
      <NotificationProvider>
        ...
        <div className="min-h-screen bg-slate-50">
          <Routes>
            ...
            <Route              path="/dashboard"              element={                <ProtectedRoute>                  <RoleBasedDashboard />                </ProtectedRoute>              }            />            <Route path="/customer/login" element={<EasyApplyLogin />} />            <Route path="/customer/consents" element={<EasyApplyConsents />} />            <Route path="/" element={<Navigate to="/dashboard" replace />} />          </Routes>          <ToastContainer />
