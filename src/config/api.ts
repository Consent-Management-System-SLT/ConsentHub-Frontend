...
// Every service in this app is served by the same backend, so one origin covers them all.
export const API_ORIGIN = import.meta.env.VITE_GATEWAY_API_URL || import.meta.env.VITE_API_URL || 'http://localhost:3001';
